...
IED_SMOKE_LARGE = {
	...
	for "_i" from 0 to _numPlumes -1 do{
		...
		switch(_r) do
		{
			case 0:
			{
				[_loc, _aslLoc, 40, 30] spawn {call SAND_TRAIL_SMOKE;};
			};
			case 1: 
			{
				[_loc, _aslLoc, 40, 30] spawn {call GRAY_TRAIL_SMOKE;};
			};
			case 2:
			{
				[_loc, _aslLoc, 40, 30] spawn {call BROWN_TRAIL_SMOKE;};
			};
		};		
...
IED_SMOKE_MEDIUM = {
	...
	0 = [_loc,_aslLoc] spawn {
		...
		for "_i" from 0 to _numPlumes -1 do{
			...
			switch(_r) do
			{
				case 0:
				{
					[_loc, _aslLoc, 120, 10] spawn {call SAND_TRAIL_SMOKE;};
				};
				case 1: 
				{
					[_loc, _aslLoc, 120, 10] spawn {call GRAY_TRAIL_SMOKE;};
				};
				case 2:
				{
					[_loc, _aslLoc, 120, 10] spawn {call BROWN_TRAIL_SMOKE;};
				};
			};		
	...
	_smoke1 setposasl _aslLoc;
	_smoke1 setParticleCircle [0, [0, 0, 0]];
	_smoke1 setParticleRandom [0, [4 + random 3, 4 + random 3, 8], [7, 7, 12], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	_smoke2 setposasl _aslLoc;
	_smoke2 setParticleCircle [0, [0, 0, 0]];
	_smoke2 setParticleRandom [0, [4 + random 3, 4 + random 3, 8], [7, 7, 12], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	_smoke3 setposasl _aslLoc;
	_smoke3 setParticleCircle [0, [0, 0, 0]];
	_smoke3 setParticleRandom [0, [4 + random 3, 4 + random 3, 8], [7, 7, 12], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	_smoke4 setposasl _aslLoc;
	_smoke4 setParticleCircle [0, [0, 0, 0]];
	_smoke4 setParticleRandom [0, [4 + random 3, 4 + random 3, 8], [7, 7, 12], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	_smoke1 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [4, 4, 6], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	_smoke2 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [4, 4, 6], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	_smoke3 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [4, 4, 6], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	_smoke4 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [4, 4, 6], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	sleep 1;
	_smoke1 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [2, 2, 2], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	_smoke2 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [2, 2, 2], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	_smoke3 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [2, 2, 2], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	_smoke4 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [2, 2, 2], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	sleep 1;
	_smoke1 setParticleRandom [0, [1 + random 3, 1 + random 3, 5], [3, 3, 3], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke1 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 30, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.35, .35, .35, 1], [.2, .2, .2, 0.9], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke1 setDropInterval .05;
	
	_smoke2 setParticleRandom [0, [1 + random 3, 1 + random 3, 5], [3, 3, 3], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke2 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 30, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.35, .35, .35, 1], [.2, .2, .2, 0.9], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke2 setDropInterval .05;
	
	_smoke3 setParticleRandom [0, [1 + random 3, 1 + random 3, 5], [3, 3, 3], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke3 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 30, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.35, .35, .35, 1], [.2, .2, .2, 0.9], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke3 setDropInterval .05;
	
	_smoke4 setParticleRandom [0, [1 + random 3, 1 + random 3, 5], [3, 3, 3], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke4 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 30, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.35, .35, .35, 1], [.2, .2, .2, 0.9], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke4 setDropInterval .05;
...
IED_SMOKE_SMALL = {
	...
	0 = [_loc,_aslLoc] spawn {
		...
		for "_i" from 0 to _numPlumes -1 do{
			...
			switch(_r) do
			{
				case 0:
				{
					[_loc, _aslLoc, 60, 20] spawn {call SAND_TRAIL_SMOKE;};
				};
				case 1: 
				{
					[_loc, _aslLoc, 60, 20] spawn {call GRAY_TRAIL_SMOKE;};
				};
				case 2:
				{
					[_loc, _aslLoc, 60, 20] spawn {call BROWN_TRAIL_SMOKE;};
				};
			};		
	...
	_smoke1 setposasl _aslLoc;
	_smoke1 setParticleCircle [0, [0, 0, 0]];
	_smoke1 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 8], [1, 1, 17], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke1 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 6, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[0, 0, 0, 1], [0.35, 0.35, 0.35, 0.35], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke1 setDropInterval .01;
	...
	_smoke2 setposasl _aslLoc;
	_smoke2 setParticleCircle [0, [0, 0, 0]];
	_smoke2 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 8], [1, 1, 17], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke2 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 6, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.78, .76, .71, 1], [.35, .35, .35, 0.35], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke2 setDropInterval .01;
	...
	_smoke3 setposasl _aslLoc;
	_smoke3 setParticleCircle [0, [0, 0, 0]];
	_smoke3 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 8], [1, 1, 17], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke3 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 6, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.55, .47, .37, 1], [.35, .35, .35, 0.35], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke3 setDropInterval .01;
	...
	_smoke4 setposasl _aslLoc;
	_smoke4 setParticleCircle [0, [0, 0, 0]];
	_smoke4 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 8], [1, 1, 17], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke4 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 6, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.1, .1, .1, 1], [.2, .2, .2, 0.35], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke4 setDropInterval .01;
	...
	_smoke1 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [1, 1, 10], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke1 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 9, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.35, .35, .35, 1], [.2, .2, .2, 0.9], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke1 setDropInterval .03;
	
	_smoke2 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [1, 1, 10], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke2 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 9, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.35, .35, .35, 1], [.2, .2, .2, 0.9], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke2 setDropInterval .03;
	
	_smoke3 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [1, 1, 10], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke3 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 9, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.35, .35, .35, 1], [.2, .2, .2, 0.9], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke3 setDropInterval .03;
	
	_smoke4 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [1, 1, 10], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke4 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 9, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.35, .35, .35, 1], [.2, .2, .2, 0.9], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke4 setDropInterval .03;
	
	sleep 1;
	_smoke1 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [1, 1, 6], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke1 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 12, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.35, .35, .35, 1], [.2, .2, .2, 0.9], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke1 setDropInterval .05;
	
	_smoke2 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [1, 1, 6], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke2 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 12, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.35, .35, .35, 1], [.2, .2, .2, 0.9], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke2 setDropInterval .05;
	
	_smoke3 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [1, 1, 6], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke3 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 12, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.35, .35, .35, 1], [.2, .2, .2, 0.9], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke3 setDropInterval .05;
	
	_smoke4 setParticleRandom [0, [1.5 + random 2, 1.5 + random 2, 5], [1, 1, 6], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	_smoke4 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 12, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, .375, [6 + random 4, 10 + random 4, 14 + random 4], [[.35, .35, .35, 1], [.2, .2, .2, 0.9], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
	_smoke4 setDropInterval .05;
	
	sleep 1;
	_smoke1 setParticleRandom [0, [1 + random 3, 1 + random 3, 5], [1, 1, 3], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	_smoke2 setParticleRandom [0, [1 + random 3, 1 + random 3, 5], [1, 1, 3], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	_smoke3 setParticleRandom [0, [1 + random 3, 1 + random 3, 5], [1, 1, 3], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
	...
	_smoke4 setParticleRandom [0, [1 + random 3, 1 + random 3, 5], [1, 1, 3], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
