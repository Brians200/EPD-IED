...
_source setParticleParams [["\A3\data_f\ParticleEffects\Universal\Universal", 8, 0, 1], "", "Billboard", 1, 10, [0,0,0.5],[0, 0, 2.9], 1, 1.275, 1, 0.066, [4, 5, 10,10], [[.3, .3, .3, 0.33], [.4, .4, .4, 0.33], [.2, .2, .2, 0]],[0,1], 1, 0, "", "", _sh];
_source setParticleRandom [0, [0, 0, 0], [0.33,0.33,0], 0, 0.25, [0.5, 0.5, 0.5, 0.5], 0, 0];
